...
## Project Structure
    ...
    ├── testapiautostoryboa_86405  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_86405`
...
2. Clone this repo and `cd testapiautostoryboa_86405`
